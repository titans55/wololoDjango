...
class ChunkedDownload(DownloadBase):
    ...
    def _process_response(self, response):
        ...
        ``bytes ***REMOVED***start***REMOVED***-***REMOVED***end***REMOVED***/***REMOVED***total***REMOVED***`` and ``***REMOVED***end***REMOVED*** - ***REMOVED***start***REMOVED*** + 1``
...
def add_bytes_range(start, end, headers):
    ...
    if start is None:
        if end is None:
            ...
            bytes_range = u'0-***REMOVED***:d***REMOVED***'.format(end)
    else:
        if end is None:
            if start < 0:
                bytes_range = u'***REMOVED***:d***REMOVED***'.format(start)
            else:
                bytes_range = u'***REMOVED***:d***REMOVED***-'.format(start)
        else:
            # NOTE: This is invalid if ``start < 0``.
            bytes_range = u'***REMOVED***:d***REMOVED***-***REMOVED***:d***REMOVED***'.format(start, end)
...
def get_range_info(response, get_headers, callback=_helpers.do_nothing):
    ...
    Raises:
        ~google.resumable_media.common.InvalidResponse: If the
            ...
            ``bytes ***REMOVED***start***REMOVED***-***REMOVED***end***REMOVED***/***REMOVED***total***REMOVED***``.
    """
    ...
    if match is None:
        ...
        raise common.InvalidResponse(
            ...
            u'Expected to be of the form "bytes ***REMOVED***start***REMOVED***-***REMOVED***end***REMOVED***/***REMOVED***total***REMOVED***"')
