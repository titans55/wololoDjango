...
_CONTENT_RANGE_TEMPLATE = u'bytes ***REMOVED***:d***REMOVED***-***REMOVED***:d***REMOVED***/***REMOVED***:d***REMOVED***'
_RANGE_UNKNOWN_TEMPLATE = u'bytes ***REMOVED***:d***REMOVED***-***REMOVED***:d***REMOVED***/*'
_EMPTY_RANGE_TEMPLATE = u'bytes */***REMOVED***:d***REMOVED***'
_BOUNDARY_WIDTH = len(str(sys.maxsize - 1))
_BOUNDARY_FORMAT = u'===============***REMOVED******REMOVED***:0***REMOVED***:d***REMOVED***d***REMOVED******REMOVED***=='.format(_BOUNDARY_WIDTH)
_MULTIPART_SEP = b'--'
_CRLF = b'\r\n'
_MULTIPART_BEGIN = (
...
_STREAM_ERROR_TEMPLATE = (
    ...
    u'The local stream has had ***REMOVED***:d***REMOVED*** bytes read from it while '
    u'***REMOVED***:d***REMOVED*** bytes have already been updated (they should match).')
_STREAM_READ_PAST_TEMPLATE = (
    u'***REMOVED***:d***REMOVED*** bytes have been read from the stream, which exceeds '
    u'the expected total ***REMOVED***:d***REMOVED***.')
_POST = u'POST'
_PUT = u'PUT'
...
class ResumableUpload(UploadBase):
    ...
    def _prepare_initiate_request(self, stream, metadata, content_type,
        ...
        ***REMOVED***
        ...
        if self._total_bytes is not None:
            content_length = u'***REMOVED***:d***REMOVED***'.format(self._total_bytes)
    ...
    def _process_response(self, response, bytes_sent):
        ...
        if status_code == http_client.OK:
            ...
            bytes_range = _helpers.header_required(
                response, _helpers.RANGE_HEADER,
            ...
            if match is None:
                ...
                raise common.InvalidResponse(
                    ...
                    u'Expected to be of the form "bytes=0-***REMOVED***end***REMOVED***"')
    ...
    def _prepare_recover_request(self):
        ...
        headers = ***REMOVED***_helpers.CONTENT_RANGE_HEADER: u'bytes */*'***REMOVED***
...
def get_content_range(start_byte, end_byte, total_bytes):
    ...
    If ``total_bytes`` is not known, uses "bytes ***REMOVED***start***REMOVED***-***REMOVED***end***REMOVED***/*".
    If we are dealing with an empty range (i.e. ``end_byte < start_byte``)
    then "bytes */***REMOVED***total***REMOVED***" is used.
