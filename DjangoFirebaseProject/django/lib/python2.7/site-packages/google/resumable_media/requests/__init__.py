...
.. doctest:: basic-download
   ...
   ...     u'***REMOVED***bucket***REMOVED***/o/***REMOVED***blob_name***REMOVED***?alt=media')
...
.. testsetup:: basic-download-with-slice
   ...
   fake_response.headers[u'Content-Length'] = u'***REMOVED***:d***REMOVED***'.format(slice_size)
   content_range = u'bytes ***REMOVED***:d***REMOVED***-***REMOVED***:d***REMOVED***/1364156'.format(start, end)
...
.. testsetup:: chunked-download
   ...
   fake_response = requests.Response()
   fake_response.status_code = int(http_client.PARTIAL_CONTENT)
   fake_response.headers[u'Content-Length'] = u'***REMOVED***:d***REMOVED***'.format(fifty_mb)
   content_range = u'bytes 0-***REMOVED***:d***REMOVED***/***REMOVED***:d***REMOVED***'.format(fifty_mb - 1, one_gb)
   fake_response.headers[u'Content-Range'] = content_range
...
.. testsetup:: chunked-download-end
   ...
   fake_response.headers[u'Content-Length'] = u'***REMOVED***:d***REMOVED***'.format(slice_size)
   content_range = u'bytes ***REMOVED***:d***REMOVED***-***REMOVED***:d***REMOVED***/***REMOVED***:d***REMOVED***'.format(
...
.. doctest:: simple-upload
   ...
   >>>
   >>> url_template = (
   ...     u'https://www.googleapis.com/upload/storage/v1/b/***REMOVED***bucket***REMOVED***/o?'
   ...     u'uploadType=media&'
   ...     u'name=***REMOVED***blob_name***REMOVED***')
...
.. testsetup:: multipart-upload
   ...
   payload = ***REMOVED***
       u'bucket': bucket,
       u'name': blob_name,
       u'metadata': ***REMOVED***u'color': u'grurple'***REMOVED***,
   ***REMOVED***
   fake_response._content = json.dumps(payload).encode(u'utf-8')
...
.. testsetup:: resumable-initiate
   ...
   resumable_url_template = (
       u'https://www.googleapis.com/upload/storage/v1/b/***REMOVED***bucket***REMOVED***'
       u'/o?uploadType=resumable&upload_id=***REMOVED***upload_id***REMOVED***')
...
.. doctest:: resumable-initiate
   ...
   True
   >>> metadata = ***REMOVED***u'name': blob_name***REMOVED***
...
.. testsetup:: resumable-transmit
   ...
   payload = ***REMOVED***
       u'bucket': bucket,
       u'name': blob_name,
       u'size': u'***REMOVED***:d***REMOVED***'.format(len(data)),
   ***REMOVED***
