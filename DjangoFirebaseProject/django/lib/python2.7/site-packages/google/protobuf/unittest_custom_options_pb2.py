...
_TESTMESSAGEWITHCUSTOMOPTIONS_ANENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      serialized_options=_b('\260\206\372\005***REMOVED***'),
      type=None),
  ],
  containing_type=None,
