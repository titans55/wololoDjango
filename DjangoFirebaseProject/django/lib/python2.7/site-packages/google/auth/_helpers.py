...
def to_bytes(value, encoding='utf-8'):
    ...
    if isinstance(result, six.binary_type):
        ...
        raise ValueError('***REMOVED***0!r***REMOVED*** could not be converted to bytes'.format(value))
...
def from_bytes(value):
    ...
    if isinstance(result, six.text_type):
        ...
        raise ValueError(
            '***REMOVED***0!r***REMOVED*** could not be converted to unicode'.format(value))
...
def update_query(url, params, remove=None):
    ...
    Examples:
        ...
        >>> update_query(url, ***REMOVED***'a': '2'***REMOVED***)
        http://example.com?a=2
        >>> update_query(url, ***REMOVED***'b': '3'***REMOVED***)
        http://example.com?a=1&b=3
        >> update_query(url, ***REMOVED***'b': '3'***REMOVED***, remove=['a'])
