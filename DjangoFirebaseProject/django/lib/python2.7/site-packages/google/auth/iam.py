...
_SIGN_BLOB_URI = (
    _IAM_API_ROOT_URI + '/projects/-/serviceAccounts/***REMOVED******REMOVED***:signBlob?alt=json')
        ...
        ***REMOVED***)
        ...
        if response.status != http_client.OK:
            raise exceptions.TransportError(
                'Error calling the IAM signBytes API: ***REMOVED******REMOVED***'.format(
                    response.data))
