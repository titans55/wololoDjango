...
_HELP_MESSAGE = """\
Could not automatically determine credentials. Please set ***REMOVED***env***REMOVED*** or \
...
def _load_credentials_from_file(filename):
    ...
    if not os.path.exists(filename):
        raise exceptions.DefaultCredentialsError(
            'File ***REMOVED******REMOVED*** was not found.'.format(filename))
    ...
    with io.open(filename, 'r') as file_obj:
        try:
            ...
            new_exc = exceptions.DefaultCredentialsError(
                'File ***REMOVED******REMOVED*** is not a valid json file.'.format(filename),
                caught_exc)
    ...
    if credential_type == _AUTHORIZED_USER_TYPE:
        ...
        try:
            ...
            msg = 'Failed to load authorized user credentials from ***REMOVED******REMOVED***'.format(
                filename)
        ...
        try:
            ...
            msg = 'Failed to load service account credentials from ***REMOVED******REMOVED***'.format(
                filename)
            new_exc = exceptions.DefaultCredentialsError(msg, caught_exc)
            six.raise_from(new_exc, caught_exc)
        ...
        raise exceptions.DefaultCredentialsError(
            'The file ***REMOVED***file***REMOVED*** does not have a valid type. '
            'Type is ***REMOVED***type***REMOVED***, expected one of ***REMOVED***valid_types***REMOVED***.'.format(
