...
_METADATA_ROOT = 'http://***REMOVED******REMOVED***/computeMetadata/v1/'.format(
    os.getenv(environment_vars.GCE_METADATA_ROOT, 'metadata.google.internal'))

# This is used to ping the metadata server, it avoids the cost of a DNS
# lookup.
_METADATA_IP_ROOT = 'http://***REMOVED******REMOVED***'.format(
    os.getenv(environment_vars.GCE_METADATA_IP, '169.254.169.254'))
_METADATA_FLAVOR_HEADER = 'metadata-flavor'
_METADATA_FLAVOR_VALUE = 'Google'
_METADATA_HEADERS = ***REMOVED***_METADATA_FLAVOR_HEADER: _METADATA_FLAVOR_VALUE***REMOVED***
        ...
        if response.headers['content-type'] == 'application/json':
            try:
                ...
                new_exc = exceptions.TransportError(
                    ...
                    'metadata service: ***REMOVED***:.20***REMOVED***'.format(content))
                six.raise_from(new_exc, caught_exc)
        else:
            return content
    else:
        raise exceptions.TransportError(
            'Failed to retrieve ***REMOVED******REMOVED*** from the Google Compute Engine'
            'metadata service. Status: ***REMOVED******REMOVED*** Response:\n***REMOVED******REMOVED***'.format(
...
def get_service_account_info(request, service_account='default'):
    ...
    return get(
        request,
        'instance/service-accounts/***REMOVED***0***REMOVED***/'.format(service_account),
        recursive=True)
...
def get_service_account_token(request, service_account='default'):
    ...
    token_json = get(
        request,
        'instance/service-accounts/***REMOVED***0***REMOVED***/token'.format(service_account))
