...
class _ACLEntity(object):
    ...
    def __str__(self):
        if not self.identifier:
            ...
            return "***REMOVED***acl.type***REMOVED***-***REMOVED***acl.identifier***REMOVED***".format(acl=self)

    def __repr__(self):
        return "<ACL Entity: ***REMOVED***acl***REMOVED*** (***REMOVED***roles***REMOVED***)>".format(
    ...
    ***REMOVED***
    ...
    def __iter__(self):
        ...
        for entity in self.entities.values():
            for role in entity.get_roles():
                if role:
                    yield ***REMOVED***"entity": str(entity), "role": role***REMOVED***
    ...
    def _save(self, acl, predefined, client):
        ...
        :param client: Optional. The client to use.  If not passed, falls back
                       to the ``client`` stored on the ACL's parent.
        """
        query_params = ***REMOVED***"projection": "full"***REMOVED***
        ...
        result = client._connection.api_request(
            method="PATCH",
            path=path,
            data=***REMOVED***self._URL_PATH_ELEM: list(acl)***REMOVED***,
