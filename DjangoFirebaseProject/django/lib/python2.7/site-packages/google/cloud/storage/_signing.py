...
def generate_signed_url(
    ...
    if method == "RESUMABLE":
        method = "POST"
        canonicalized_resource = "x-goog-resumable:start\n***REMOVED***0***REMOVED***".format(resource)
    else:
        canonicalized_resource = "***REMOVED***0***REMOVED***".format(resource)
    ...
    return "***REMOVED***endpoint***REMOVED******REMOVED***resource***REMOVED***?***REMOVED***querystring***REMOVED***".format(
