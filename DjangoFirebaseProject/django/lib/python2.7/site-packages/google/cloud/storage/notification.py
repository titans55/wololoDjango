...
_TOPIC_REF_FMT = "//pubsub.googleapis.com/projects/***REMOVED******REMOVED***/topics/***REMOVED******REMOVED***"
_PROJECT_PATTERN = r"(?P<project>[a-z][a-z0-9-]***REMOVED***4,28***REMOVED***[a-z0-9])"
...
_BAD_TOPIC = (
    "Resource has invalid topic: ***REMOVED******REMOVED***; see "
...
class BucketNotification(object):
    ...
    def path(self):
        ...
        return "/b/***REMOVED******REMOVED***/notificationConfigs/***REMOVED******REMOVED***".format(
    ...
    def create(self, client=None):
        ...
        if self.notification_id is not None:
            raise ValueError(
                "Notification already exists w/ id: ***REMOVED******REMOVED***".format(self.notification_id)
            )
        ...
        path = "/b/***REMOVED******REMOVED***/notificationConfigs".format(self.bucket.name)
...
def _parse_topic_path(topic_path):
    ...
    Expected to be of the form:
        ...
        //pubsub.googleapis.com/projects/***REMOVED***project***REMOVED***/topics/***REMOVED***topic***REMOVED***
