...
_DOWNLOAD_URL_TEMPLATE = (
    u"https://www.googleapis.com/download/storage/v1***REMOVED***path***REMOVED***?alt=media"
)
_BASE_UPLOAD_TEMPLATE = (
    u"https://www.googleapis.com/upload/storage/v1***REMOVED***bucket_path***REMOVED***/o?uploadType="
)
...
_READ_LESS_THAN_SIZE = (
    "Size ***REMOVED***:d***REMOVED*** was specified but the file-like object only had " "***REMOVED***:d***REMOVED*** bytes remaining."
)
...
class Blob(_PropertyMixin):
    ...
    def public_url(self):
        ...
        """
        return "***REMOVED***storage_base_url***REMOVED***/***REMOVED***bucket_name***REMOVED***/***REMOVED***quoted_name***REMOVED***".format(
    ...
    def generate_signed_url(
        ...
        :returns: A signed URL you can use to access the resource
                  until expiration.
        """
        resource = "/***REMOVED***bucket_name***REMOVED***/***REMOVED***quoted_name***REMOVED***".format(
    ...
    def _get_download_url(self):
        ...
        if self.media_link is None:
            ...
            if self.generation is not None:
                name_value_pairs.append(("generation", "***REMOVED***:d***REMOVED***".format(self.generation)))
        else:
    ...
    def _get_writable_metadata(self):
        ...
        * ``storageClass``
        ...
        object_metadata = ***REMOVED***"name": self.name***REMOVED***
    ...
    def compose(self, sources, client=None):
        ...
        request = ***REMOVED***
            "sourceObjects": [***REMOVED***"name": source.name***REMOVED*** for source in sources],
...
def _raise_from_invalid_response(error):
    ...
    message = u"***REMOVED***method***REMOVED*** ***REMOVED***url***REMOVED***: ***REMOVED***error***REMOVED***".format(
