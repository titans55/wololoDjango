...
class LifecycleRuleDelete(dict):
    ...
    def __init__(self, **kw):
        ...
        rule = ***REMOVED***"action": ***REMOVED***"type": "Delete"***REMOVED***, "condition": dict(conditions)***REMOVED***
...
class LifecycleRuleSetStorageClass(dict):
    ...
    def __init__(self, storage_class, **kw):
        conditions = LifecycleRuleConditions(**kw)
        rule = ***REMOVED***
            "action": ***REMOVED***"type": "SetStorageClass", "storageClass": storage_class***REMOVED***,
...
class Bucket(_PropertyMixin):
    ...
    def exists(self, client=None):
        ...
        query_params = ***REMOVED***"fields": "name"***REMOVED***
    ...
    def create(self, client=None, project=None, location=None):
        ...
        query_params = ***REMOVED***"project": project***REMOVED***
        properties = ***REMOVED***key: self._properties[key] for key in self._changes***REMOVED***
    ...
    def patch(self, client=None):
        ...
        if self._label_removals:
            ...
            self._properties.setdefault("labels", ***REMOVED******REMOVED***)
    ...
    def list_blobs(
        ...
        """
        extra_params = ***REMOVED***"projection": projection***REMOVED***
    ...
    def copy_blob(
        ...
        if not preserve_acl:
            new_blob.acl.save(acl=***REMOVED******REMOVED***, client=client)
    ...
    def cors(self):
        ...
        .. note::
           ...
           *copies* of the bucket's CORS policy mappings.  Mutating the list
           ...
           >>> policies.append(***REMOVED***'origin': '/foo', ...***REMOVED***)
    ...
    def default_kms_key_name(self):
        ...
        """
        encryption_config = self._properties.get("encryption", ***REMOVED******REMOVED***)
    ...
    def lifecycle_rules(self):
        ...
        .. note::
           ...
           *copies* of the bucket's lifecycle rules mappings.  Mutating the
           ...
           >>> rules.append(***REMOVED***'origin': '/foo', ...***REMOVED***)
        ...
        """
        info = self._properties.get("lifecycle", ***REMOVED******REMOVED***)
        for rule in info.get("rule", ()):
            ...
            if action_type == "Delete":
                ...
                raise ValueError("Unknown lifecycle rule: ***REMOVED******REMOVED***".format(rule))
    ...
    def lifecycle_rules(self, rules):
        ...
        self._patch_property("lifecycle", ***REMOVED***"rule": rules***REMOVED***)
    ...
    def enable_logging(self, bucket_name, object_prefix=""):
        ...
        """
        info = ***REMOVED***"logBucket": bucket_name, "logObjectPrefix": object_prefix***REMOVED***
    ...
    def retention_period(self, value):
        ...
        """
        policy = self._properties.setdefault("retentionPolicy", ***REMOVED******REMOVED***)
    ...
    def versioning_enabled(self):
        ...
        """
        versioning = self._properties.get("versioning", ***REMOVED******REMOVED***)
    ...
    def versioning_enabled(self, value):
        ...
        """
        self._patch_property("versioning", ***REMOVED***"enabled": bool(value)***REMOVED***)
    ...
    def requester_pays(self):
        ...
        """
        versioning = self._properties.get("billing", ***REMOVED******REMOVED***)
    ...
    def requester_pays(self, value):
        ...
        """
        self._patch_property("billing", ***REMOVED***"requesterPays": bool(value)***REMOVED***)
    ...
    def configure_website(self, main_page_suffix=None, not_found_page=None):
        ...
        """
        data = ***REMOVED***"mainPageSuffix": main_page_suffix, "notFoundPage": not_found_page***REMOVED***
    ...
    def test_iam_permissions(self, permissions, client=None):
        ...
        """
        client = self._require_client(client)
        query_params = ***REMOVED***"permissions": permissions***REMOVED***
    ...
    def generate_upload_policy(self, conditions, expiration=None, client=None):
        ...
        conditions = conditions + [***REMOVED***"bucket": self.name***REMOVED***]

        policy_document = ***REMOVED***
    ...
    def lock_retention_policy(self, client=None):
        ...
        query_params = ***REMOVED***"ifMetagenerationMatch": self.metageneration***REMOVED***

        if self.user_project is not None:
            query_params["userProject"] = self.user_project

        path = "/b/***REMOVED******REMOVED***/lockRetentionPolicy".format(self.name)
        api_response = client._connection.api_request(
