...
Document = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      name:
          The resource name of the document, for example ``projects/***REMOVED***pro
          ject_id***REMOVED***/databases/***REMOVED***database_id***REMOVED***/documents/***REMOVED***document_path***REMOVED***``.
      fields:
          ...
          : ***REMOVED*** map_value: ***REMOVED*** "x&y" : ***REMOVED*** string_value: "hello" ***REMOVED******REMOVED******REMOVED***`` would
...
Value = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      reference_value:
          A reference to a document. For example: ``projects/***REMOVED***project_id
          ***REMOVED***/databases/***REMOVED***database_id***REMOVED***/documents/***REMOVED***document_path***REMOVED***``.
      geo_point_value:
...
_DOCUMENT_FIELDSENTRY._options = _descriptor._ParseOptions(
    descriptor_pb2.MessageOptions(), _b("8\001")
)
_MAPVALUE_FIELDSENTRY.has_options = True
_MAPVALUE_FIELDSENTRY._options = _descriptor._ParseOptions(
    descriptor_pb2.MessageOptions(), _b("8\001")
)
