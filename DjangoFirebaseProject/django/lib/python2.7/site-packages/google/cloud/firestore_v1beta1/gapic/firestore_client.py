...
class FirestoreClient(object):
    ...
    def database_root_path(cls, project, database):
        ...
        return google.api_core.path_template.expand(
            "projects/***REMOVED***project***REMOVED***/databases/***REMOVED***database***REMOVED***",
            project=project,
            database=database,
        )
    ...
    def document_path_path(cls, project, database, document_path):
        ...
        return google.api_core.path_template.expand(
            "projects/***REMOVED***project***REMOVED***/databases/***REMOVED***database***REMOVED***/documents/***REMOVED***document_path=*****REMOVED***",
            project=project,
            database=database,
    ...
    def any_path_path(cls, project, database, document, any_path):
        ...
        return google.api_core.path_template.expand(
            "projects/***REMOVED***project***REMOVED***/databases/***REMOVED***database***REMOVED***/documents/***REMOVED***document***REMOVED***/***REMOVED***any_path=*****REMOVED***",
            project=project,
            database=database,
            document=document,
            any_path=any_path,
    ...
    def __init__(
        ...
        self._inner_api_calls = ***REMOVED******REMOVED***
    ...
    def write(
        ...
        Example:
            ...
            >>>
            >>> database = client.database_root_path('[PROJECT]', '[DATABASE]')
            >>> request = ***REMOVED***'database': database***REMOVED***
            >>>
            >>> requests = [request]
