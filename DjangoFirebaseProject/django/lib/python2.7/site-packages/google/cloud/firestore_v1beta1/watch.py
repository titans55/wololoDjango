...
class Watch(object):
    ...
    def _on_rpc_done(self, future):
        ...
        thread = threading.Thread(
            name=_RPC_ERROR_THREAD_NAME, target=self.close, kwargs=***REMOVED***"reason": future***REMOVED***
        )
        thread.daemon = True
        thread.start()
    ...
    def for_document(
        ...
        return cls(
            ...
            ***REMOVED***
                "documents": ***REMOVED***"documents": [document_ref._document_path]***REMOVED***,
    ...
    def for_query(
        ...
        return cls(
            query,
            query._client,
            ***REMOVED***"query": query_target, "target_id": WATCH_TARGET_ID***REMOVED***,
            query._comparator,
            snapshot_callback,
            snapshot_class_instance,
            reference_class_instance,
    ...
    def on_snapshot(self, proto):
        ...
        target_changetype_dispatch = ***REMOVED***
