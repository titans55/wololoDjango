...
***REMOVED***
_BAD_OP_STRING = "Operator string ***REMOVED***!r***REMOVED*** is invalid. Valid choices are: ***REMOVED******REMOVED***."
...
_BAD_DIR_STRING = "Invalid direction ***REMOVED***!r***REMOVED***. Must be one of ***REMOVED***!r***REMOVED*** or ***REMOVED***!r***REMOVED***."
_INVALID_CURSOR_TRANSFORM = "Transforms cannot be used as cursor values."
_MISSING_ORDER_BY = (
    'The "order by" field path ***REMOVED***!r***REMOVED*** is not present in the cursor data ***REMOVED***!r***REMOVED***. '
...
_MISMATCH_CURSOR_W_ORDER_BY = "The cursor ***REMOVED***!r***REMOVED*** does not match the order fields ***REMOVED***!r***REMOVED***."
_EMPTY_DOC_TEMPLATE = (
    "Unexpected server response. All responses other than the first must "
    "contain a document. The response at index ***REMOVED******REMOVED*** was\n***REMOVED******REMOVED***."
)
        ...
        Example:
            ...
            def on_snapshot(query_snapshot):
                for doc in query_snapshot.documents:
                    print(u'***REMOVED******REMOVED*** => ***REMOVED******REMOVED***'.format(doc.id, doc.to_dict()))
