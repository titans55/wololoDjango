...
_BAD_DOC_TEMPLATE = (
    "Document ***REMOVED***!r***REMOVED*** appeared in response but was not present among references"
)
    ...
    def write_option(**kwargs):
        ...
        * ``exists`` (:class:`bool`): Indicates if the document being modified
        ...
        if name == "last_update_time":
            ...
            extra = "***REMOVED***!r***REMOVED*** was provided".format(name)
