...
_CANT_BEGIN = "The transaction has already begun. Current transaction ID: ***REMOVED***!r***REMOVED***."
_MISSING_ID_TEMPLATE = "The transaction has no transaction ID, so it cannot be ***REMOVED******REMOVED***."
...
_EXCEED_ATTEMPTS_TEMPLATE = "Failed to commit transaction in ***REMOVED***:d***REMOVED*** attempts."
