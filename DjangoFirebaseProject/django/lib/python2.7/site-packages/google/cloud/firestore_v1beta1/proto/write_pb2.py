...
Write = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      update:
          A document to write.
      delete:
          A document name to delete. In the format: ``projects/***REMOVED***project_
          id***REMOVED***/databases/***REMOVED***database_id***REMOVED***/documents/***REMOVED***document_path***REMOVED***``.
      transform:
