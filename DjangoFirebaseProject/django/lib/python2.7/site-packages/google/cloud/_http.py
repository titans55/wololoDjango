...
DEFAULT_USER_AGENT = "gcloud-python/***REMOVED***0***REMOVED***".format(
    get_distribution("google-cloud-core").version
)
"""The user agent for google-cloud-python requests."""

CLIENT_INFO_HEADER = "X-Goog-API-Client"
CLIENT_INFO_TEMPLATE = "gl-python/" + platform.python_version() + " gccl/***REMOVED******REMOVED***"
...
class Connection(object):
    ...
    _EXTRA_HEADERS = ***REMOVED******REMOVED***
...
class JSONConnection(Connection):
    ...
    * :attr:`API_URL_TEMPLATE`
    ...
    def build_api_url(
        ...
        query_params = query_params or ***REMOVED******REMOVED***
        if query_params:
    ...
    def _make_request(
        ...
        """
        headers = headers or ***REMOVED******REMOVED***
