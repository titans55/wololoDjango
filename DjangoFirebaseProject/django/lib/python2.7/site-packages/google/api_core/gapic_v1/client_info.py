...
class ClientInfo(object):
    ...
    def to_user_agent(self):
        ...
        ua = "gl-python/***REMOVED***python_version***REMOVED*** "

        if self.grpc_version is not None:
            ua += "grpc/***REMOVED***grpc_version***REMOVED*** "

        ua += "gax/***REMOVED***api_core_version***REMOVED*** "

        if self.gapic_version is not None:
            ua += "gapic/***REMOVED***gapic_version***REMOVED*** "

        if self.client_library_version is not None:
            ua += "gccl/***REMOVED***client_library_version***REMOVED*** "
