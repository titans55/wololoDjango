...
def parse_method_configs(interface_config):
    ...
    retry_codes_map = ***REMOVED***
        name: retry_codes
        for name, retry_codes in six.iteritems(interface_config.get("retry_codes", ***REMOVED******REMOVED***))
    ***REMOVED***

    # Grab all of the retry params
    retry_params_map = ***REMOVED***
        name: retry_params
        for name, retry_params in six.iteritems(
            interface_config.get("retry_params", ***REMOVED******REMOVED***)
        )
    ***REMOVED***

    # Iterate through all the API methods and create a flat MethodConfig
    # instance for each one.
    method_configs = ***REMOVED******REMOVED***

    for method_name, method_params in six.iteritems(
        interface_config.get("methods", ***REMOVED******REMOVED***)
    ):
