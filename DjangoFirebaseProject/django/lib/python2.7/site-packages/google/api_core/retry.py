...
def retry_target(target, predicate, sleep_generator, deadline, on_error=None):
    ...
    for sleep in sleep_generator:
        ...
        if deadline_datetime is not None and deadline_datetime < now:
            six.raise_from(
                exceptions.RetryError(
                    "Deadline of ***REMOVED***:.1f***REMOVED***s exceeded while calling ***REMOVED******REMOVED***".format(
                        deadline, target
                    ),
                    last_exc,
                ),
        ...
        _LOGGER.debug(
            "Retrying due to ***REMOVED******REMOVED***, sleeping ***REMOVED***:.1f***REMOVED***s ...".format(last_exc, sleep)
        )
        time.sleep(sleep)
...
class Retry(object):
    ...
    def __str__(self):
        return (
            "<Retry predicate=***REMOVED******REMOVED***, initial=***REMOVED***:.1f***REMOVED***, maximum=***REMOVED***:.1f***REMOVED***, "
            "multiplier=***REMOVED***:.1f***REMOVED***, deadline=***REMOVED***:.1f***REMOVED***>".format(
                self._predicate,
                self._initial,
                self._maximum,
                self._multiplier,
