...
Assigning to '***REMOVED******REMOVED***' is deprecated.  Replace with 'policy[***REMOVED******REMOVED***] = members."""
    ...
    def to_api_repr(self):
        ...
        if self._bindings:
            ...
            for role, members in sorted(self._bindings.items()):
                if members:
                    bindings.append(***REMOVED***"role": role, "members": sorted(set(members))***REMOVED***)
