...
.. code-block:: python
    ...
    for n in range(10):
        try:
            is_thing_ready_with_timeout(***REMOVED***'example': 'data'***REMOVED***)
        except:
            pass
...
class ConstantTimeout(object):
    ...
    def __str__(self):
        return "<ConstantTimeout timeout=***REMOVED***:.1f***REMOVED***>".format(self._timeout)
...
class ExponentialTimeout(object):
    ...
    def __str__(self):
        return (
            "<ExponentialTimeout initial=***REMOVED***:.1f***REMOVED***, maximum=***REMOVED***:.1f***REMOVED***, "
