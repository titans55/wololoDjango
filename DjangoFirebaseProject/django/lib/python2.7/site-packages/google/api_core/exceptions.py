...
_HTTP_CODE_TO_EXCEPTION = ***REMOVED******REMOVED***
_GRPC_CODE_TO_EXCEPTION = ***REMOVED******REMOVED***
...
class RetryError(GoogleAPIError):
    ...
    def __str__(self):
        return "***REMOVED******REMOVED***, last exception: ***REMOVED******REMOVED***".format(self.message, self.cause)
...
class GoogleAPICallError(GoogleAPIError):
    ...
    def __str__(self):
        return "***REMOVED******REMOVED*** ***REMOVED******REMOVED***".format(self.code, self.message)
...
def from_http_response(response):
    ...
    try:
        ...
        payload = ***REMOVED***"error": ***REMOVED***"message": response.text or "unknown error"***REMOVED******REMOVED***

    error_message = payload.get("error", ***REMOVED******REMOVED***).get("message", "unknown error")
    errors = payload.get("error", ***REMOVED******REMOVED***).get("errors", ())

    message = "***REMOVED***method***REMOVED*** ***REMOVED***url***REMOVED***: ***REMOVED***error***REMOVED***".format(
