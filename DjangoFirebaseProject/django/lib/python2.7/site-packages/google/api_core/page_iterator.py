...
a request)::
    ...
    ...     print('=' * 20)
    ...     print('    Page number: ***REMOVED***:d***REMOVED***'.format(iterator.page_number))
    ...     print('  Items in page: ***REMOVED***:d***REMOVED***'.format(page.num_items))
    ...     print('     First item: ***REMOVED***!r***REMOVED***'.format(next(page)))
    ...     print('Items remaining: ***REMOVED***:d***REMOVED***'.format(page.remaining))
    ...     print('Next page token: ***REMOVED******REMOVED***'.format(iterator.next_page_token))
    ====================
        Page number: 1
      Items in page: 1
...
class HTTPIterator(Iterator):
    ...
    def __init__(
        ...
        if self.extra_params is None:
            self.extra_params = ***REMOVED******REMOVED***
        self._verify_params()
