...
_RFC3339_NANOS = re.compile(
    r"""
    (?P<no_fraction>
        \d***REMOVED***4***REMOVED***-\d***REMOVED***2***REMOVED***-\d***REMOVED***2***REMOVED***T\d***REMOVED***2***REMOVED***:\d***REMOVED***2***REMOVED***:\d***REMOVED***2***REMOVED***  # YYYY-MM-DDTHH:MM:SS
    )
    (                                        # Optional decimal part
     \.                                      # decimal point
     (?P<nanos>\d***REMOVED***1,9***REMOVED***)                      # nanoseconds, maybe truncated
    )?
    Z                                        # Zulu
""",
    re.VERBOSE,
...
def from_rfc3339_nanos(value):
    ...
    if with_nanos is None:
        raise ValueError(
            "Timestamp: ***REMOVED***!r***REMOVED***, does not match pattern: ***REMOVED***!r***REMOVED***".format(
...
class DatetimeWithNanoseconds(datetime.datetime):
    ...
    def rfc3339(self):
        ...
        return "***REMOVED******REMOVED***.***REMOVED******REMOVED***Z".format(self.strftime(_RFC3339_NO_FRACTION), nanos)
    ...
    def from_rfc3339(cls, stamp):
        ...
        if with_nanos is None:
            raise ValueError(
                "Timestamp: ***REMOVED******REMOVED***, does not match pattern: ***REMOVED******REMOVED***".format(
