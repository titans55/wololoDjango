    ...
    def __call__(self, request, timeout=None, metadata=None, credentials=None):
        ...
        if self.responses is not None:
            if response is None:
                ...
                raise ValueError(
                    "***REMOVED***method***REMOVED***.response and ***REMOVED***method***REMOVED***.responses are mutually "
        ...
        raise ValueError('Method stub for "***REMOVED******REMOVED***" has no response.'.format(self._method))
...
class ChannelStub(grpc.Channel):
    ...
    def __init__(self, responses=[]):
        ...
        message."""
        self._method_stubs = ***REMOVED******REMOVED***
