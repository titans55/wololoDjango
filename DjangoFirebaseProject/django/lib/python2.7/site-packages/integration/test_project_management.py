...
def test_android_set_display_name_and_get_metadata(android_app, project_id):
    ...
    new_display_name = '***REMOVED***0***REMOVED*** helloworld ***REMOVED***1***REMOVED***'.format(
    ...
    assert metadata._name == 'projects/***REMOVED***0***REMOVED***/androidApps/***REMOVED***1***REMOVED***'.format(project_id, app_id)
...
def test_ios_set_display_name_and_get_metadata(ios_app, project_id):
    ...
    assert metadata._name == 'projects/***REMOVED***0***REMOVED***/iosApps/***REMOVED***1***REMOVED***'.format(project_id, app_id)
    assert metadata.app_id == app_id
    assert metadata.project_id == project_id
    assert metadata.display_name == new_display_name
