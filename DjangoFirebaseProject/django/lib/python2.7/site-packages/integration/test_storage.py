...
def test_default_bucket(project_id):
    ...
    _verify_bucket(bucket, '***REMOVED***0***REMOVED***.appspot.com'.format(project_id))

def test_custom_bucket(project_id):
    bucket_name = '***REMOVED***0***REMOVED***.appspot.com'.format(project_id)
...
def _verify_bucket(bucket, expected_name):
    ...
    file_name = 'data_***REMOVED***0***REMOVED***.txt'.format(int(time.time()))
