...
class UserProvider(object):
    ...
    def to_dict(self):
        ...
        ***REMOVED***
        return ***REMOVED***k: v for k, v in payload.items() if v is not None***REMOVED***
...
class UserImportHash(object):
    ...
    def to_dict(self):
        payload = ***REMOVED***'hashAlgorithm': self._name***REMOVED***
        if self._data:
    ...
    def _basic_hash(cls, name, rounds):
        data = ***REMOVED***'rounds': _auth_utils.validate_int(rounds, 'rounds', 0, 120000)***REMOVED***
        return UserImportHash(name, data)
