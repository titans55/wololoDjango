...
def _check_is_string_or_none(obj, field_name):
    if obj is None or isinstance(obj, six.string_types):
        return obj
    raise ValueError('***REMOVED***0***REMOVED*** must be a string.'.format(field_name))


def _check_is_nonempty_string(obj, field_name):
    if isinstance(obj, six.string_types) and obj:
        return obj
    raise ValueError('***REMOVED***0***REMOVED*** must be a non-empty string.'.format(field_name))
...
def _check_not_none(obj, field_name):
    if obj is None:
        raise ValueError('***REMOVED***0***REMOVED*** cannot be None.'.format(field_name))
    return obj
...
class ShaCertificate(object):
    ...
    _SHA_1_RE = re.compile('^[0-9A-Fa-f]***REMOVED***40***REMOVED***$')
    _SHA_256_RE = re.compile('^[0-9A-Fa-f]***REMOVED***64***REMOVED***$')
...
class _ProjectManagementService(object):
    ...
    ***REMOVED***
    ...
    def _get_app_metadata(self, platform_resource_name, identifier_name, metadata_class, app_id):
        ...
        path = '/v1beta1/projects/-/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***'.format(platform_resource_name, app_id)
    ...
    def _set_display_name(self, app_id, new_display_name, platform_resource_name):
        ...
        path = '/v1beta1/projects/-/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***?updateMask=displayName'.format(
            platform_resource_name, app_id)
        request_body = ***REMOVED***'displayName': new_display_name***REMOVED***
    ...
    def _list_apps(self, platform_resource_name, app_class):
        ...
        path = '/v1beta1/projects/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***?pageSize=***REMOVED***2***REMOVED***'.format(
            self._project_id,
        ...
        while True:
            ...
            path = '/v1beta1/projects/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***?pageToken=***REMOVED***2***REMOVED***&pageSize=***REMOVED***3***REMOVED***'.format(
                self._project_id,
                platform_resource_name,
                next_page_token,
                _ProjectManagementService.MAXIMUM_LIST_APPS_PAGE_SIZE)
    ...
    def _create_app(
        ...
        path = '/v1beta1/projects/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***'.format(self._project_id, platform_resource_name)
        request_body = ***REMOVED***identifier_name: identifier***REMOVED***
        if display_name:
    ...
    def _poll_app_creation(self, operation_name):
        ...
        for current_attempt in range(_ProjectManagementService.MAXIMUM_POLLING_ATTEMPTS):
            ...
            path = '/v1/***REMOVED***0***REMOVED***'.format(operation_name)
    ...
    def _get_app_config(self, platform_resource_name, app_id):
        path = '/v1beta1/projects/-/***REMOVED***0***REMOVED***/***REMOVED***1***REMOVED***/config'.format(platform_resource_name, app_id)
        response = self._make_request('get', path, app_id, 'App ID')
    ...
    def get_sha_certificates(self, app_id):
        path = '/v1beta1/projects/-/androidApps/***REMOVED***0***REMOVED***/sha'.format(app_id)
        response = self._make_request('get', path, app_id, 'App ID')
    ...
    def add_sha_certificate(self, app_id, certificate_to_add):
        ...
        request_body = ***REMOVED***'shaHash': sha_hash, 'certType': cert_type***REMOVED***
    ...
    def delete_sha_certificate(self, certificate_to_delete):
        ...
        path = '/v1beta1/***REMOVED***0***REMOVED***'.format(name)
    ...
    def _extract_message(identifier, identifier_label, error):
        if not isinstance(error, requests.exceptions.RequestException) or error.response is None:
            return '***REMOVED***0***REMOVED*** "***REMOVED***1***REMOVED***": ***REMOVED***2***REMOVED***'.format(identifier_label, identifier, str(error))
        status = error.response.status_code
        message = _ProjectManagementService.ERROR_CODES.get(status)
        if message:
            return '***REMOVED***0***REMOVED*** "***REMOVED***1***REMOVED***": ***REMOVED***2***REMOVED***'.format(identifier_label, identifier, message)
        return '***REMOVED***0***REMOVED*** "***REMOVED***1***REMOVED***": Error ***REMOVED***2***REMOVED***.'.format(identifier_label, identifier, status)
