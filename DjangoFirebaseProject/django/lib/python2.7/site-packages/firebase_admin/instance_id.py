...
class _InstanceIdService(object):
    ...
    ***REMOVED***
    ...
    def delete_instance_id(self, instance_id):
        ...
        path = 'project/***REMOVED***0***REMOVED***/instanceId/***REMOVED***1***REMOVED***'.format(self._project_id, instance_id)
        try:
    ...
    def _extract_message(self, instance_id, error):
        ...
        if msg:
            return 'Instance ID "***REMOVED***0***REMOVED***": ***REMOVED***1***REMOVED***'.format(instance_id, msg)
        else:
            return str(error)
