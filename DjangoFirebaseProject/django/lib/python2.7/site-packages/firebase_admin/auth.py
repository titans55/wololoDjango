...
def verify_id_token(id_token, app=None, check_revoked=False):
    ...
    if not isinstance(check_revoked, bool):
        ...
        raise ValueError('Illegal check_revoked argument. Argument must be of type '
                         ' bool, but given "***REMOVED***0***REMOVED***".'.format(type(app)))
...
def _check_jwt_revoked(verified_claims, error_code, label, app):
    ...
    if verified_claims.get('iat') * 1000 < user.tokens_valid_after_timestamp:
        raise AuthError(error_code, 'The Firebase ***REMOVED***0***REMOVED*** has been revoked.'.format(label))
...
class _AuthHTTPClient(object):
    ...
    def __init__(self, app):
        ...
        version_header = 'Python/Admin/***REMOVED***0***REMOVED***'.format(firebase_admin.__version__)
        session.headers.update(***REMOVED***'X-Client-Version': version_header***REMOVED***)
