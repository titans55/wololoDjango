...
class Certificate(Base):
    ...
    def __init__(self, cert):
        ...
        if isinstance(cert, six.string_types):
            ...
            raise ValueError(
                'Invalid certificate argument: "***REMOVED***0***REMOVED***". Certificate argument must be a file path, '
        ...
        if json_data.get('type') != self._CREDENTIAL_TYPE:
            raise ValueError('Invalid service account certificate. Certificate must contain a '
                             '"type" field set to "***REMOVED***0***REMOVED***".'.format(self._CREDENTIAL_TYPE))
        try:
            ...
            raise ValueError('Failed to initialize a certificate credential. '
                             'Caused by: "***REMOVED***0***REMOVED***"'.format(error))
...
class RefreshToken(Base):
    ...
    def __init__(self, refresh_token):
        ...
        if isinstance(refresh_token, six.string_types):
            ...
            raise ValueError(
                'Invalid refresh token argument: "***REMOVED***0***REMOVED***". Refresh token argument must be a file '
