...
class Pep517HookCaller(object):
    ...
    def get_requires_for_build_wheel(self, config_settings=None):
        ...
        subprocess.
        """
        return self._call_hook('get_requires_for_build_wheel', ***REMOVED***
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory, config_settings=None):
        ...
        """
        return self._call_hook('prepare_metadata_for_build_wheel', ***REMOVED***
    ...
    def build_wheel(self, wheel_directory, config_settings=None, metadata_directory=None):
        ...
        if metadata_directory is not None:
            metadata_directory = abspath(metadata_directory)
        return self._call_hook('build_wheel', ***REMOVED***
    ...
    def get_requires_for_build_sdist(self, config_settings=None):
        ...
        subprocess.
        """
        return self._call_hook('get_requires_for_build_sdist', ***REMOVED***
            'config_settings': config_settings
        ***REMOVED***)
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        ...
        """
        return self._call_hook('build_sdist', ***REMOVED***
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        with tempdir() as td:
            compat.write_json(***REMOVED***'kwargs': kwargs***REMOVED***, pjoin(td, 'input.json'),
                              indent=2)
