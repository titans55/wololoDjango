...
class Metadata(object):
    ...
    SUMMARY_MATCHER = re.compile('.***REMOVED***1,2047***REMOVED***')

    METADATA_VERSION = '2.0'

    GENERATOR = 'distlib (%s)' % __version__

    MANDATORY_KEYS = ***REMOVED***
        'name': (),
        'version': (),
        'summary': ('legacy',),
    ***REMOVED***
        ...
        ***REMOVED***
        ...
        for ok, nk in keys:
            if ok in lmd and lmd[ok]:
                result[nk] = [***REMOVED***'requires': lmd[ok]***REMOVED***]
        result['provides'] = self.provides
        author = ***REMOVED******REMOVED***
        maintainer = ***REMOVED******REMOVED***
        return result

    LEGACY_MAPPING = ***REMOVED***
        'name': 'Name',
        'version': 'Version',
        'license': 'License',
        'summary': 'Summary',
        ...
        if self._legacy:
            ...
            for entry in run_requires:
                if 'environment' not in entry and 'extra' not in entry:
                    ...
                    break
            if always is None:
                always = ***REMOVED*** 'requires': requirements ***REMOVED***
