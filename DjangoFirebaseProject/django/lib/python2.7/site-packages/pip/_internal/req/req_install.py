...
class InstallRequirement(object):
    ...
    def __init__(self, req, comes_from, source_dir=None, editable=False,
        ...
        self.options = options if options else ***REMOVED******REMOVED***
    ...
    def is_pinned(self):
        ...
        return (len(specifiers) == 1 and
                next(iter(specifiers)).operator in ***REMOVED***'==', '==='***REMOVED***)
    ...
    def match_markers(self, extras_requested=None):
        ...
        if self.markers is not None:
            return any(
                self.markers.evaluate(***REMOVED***'extra': extra***REMOVED***)
    ...
    def has_hash_options(self):
        ...
        """
        return bool(self.options.get('hashes', ***REMOVED******REMOVED***))
    ...
    def hashes(self, trust_internet=True):
        ...
        """
        good_hashes = self.options.get('hashes', ***REMOVED******REMOVED***).copy()
    ...
    def install_editable(self, install_options,
        ...
        if prefix:
            prefix_param = ['--prefix=***REMOVED******REMOVED***'.format(prefix)]
