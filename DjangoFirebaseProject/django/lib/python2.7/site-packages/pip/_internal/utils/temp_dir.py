...
class TempDirectory(object):
    ...
    def __repr__(self):
        return "<***REMOVED******REMOVED*** ***REMOVED***!r***REMOVED***>".format(self.__class__.__name__, self.path)
    ...
    def create(self):
        ...
        if self.path is not None:
            logger.debug(
                "Skipped creation of temporary directory: ***REMOVED******REMOVED***".format(self.path)
            )
            return
        ...
        self.path = os.path.realpath(
            tempfile.mkdtemp(prefix="pip-***REMOVED******REMOVED***-".format(self.kind))
        )
        logger.debug("Created temporary directory: ***REMOVED******REMOVED***".format(self.path))
