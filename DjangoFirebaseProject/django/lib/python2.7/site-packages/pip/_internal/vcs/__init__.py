...
class RevOptions(object):
    ...
    def __repr__(self):
        return '<RevOptions ***REMOVED******REMOVED***: rev=***REMOVED***!r***REMOVED***>'.format(self.vcs.name, self.rev)
    ...
    def to_display(self):
        ...
        return ' (to revision ***REMOVED******REMOVED***)'.format(self.rev)
...
class VcsSupport(object):
    _registry = ***REMOVED******REMOVED***  # type: Dict[str, Command]
...
class VersionControl(object):
    ...
    def get_url_rev_and_auth(self, url):
        ...
        if '+' not in scheme:
            raise ValueError(
                "Sorry, ***REMOVED***!r***REMOVED*** is a malformed VCS url. "
    ...
    def get_src_requirement(self, dist, location):
        ...
        like:
          ***REMOVED***repository_url***REMOVED***@***REMOVED***revision***REMOVED***#egg=***REMOVED***project_name***REMOVED***-***REMOVED***version_identifier***REMOVED***
        """
        raise NotImplementedError
