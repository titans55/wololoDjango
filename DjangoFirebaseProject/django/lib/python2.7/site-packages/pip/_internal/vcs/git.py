...
HASH_REGEX = re.compile('[a-fA-F0-9]***REMOVED***40***REMOVED***')
    ...
    def get_revision_sha(self, dest, rev):
        ...
        for line in output.strip().splitlines():
            try:
                ...
                raise ValueError('unexpected show-ref line: ***REMOVED***!r***REMOVED***'.format(line))

            refs[ref] = sha

        branch_ref = 'refs/remotes/origin/***REMOVED******REMOVED***'.format(rev)
        tag_ref = 'refs/tags/***REMOVED******REMOVED***'.format(rev)
    ...
    def fetch_new(self, dest, url, rev_options):
        ...
        if rev_options.rev:
            ...
            if branch_name is None:
                ...
                track_branch = 'origin/***REMOVED******REMOVED***'.format(branch_name)
                cmd_args = [
