...
CYGRPC_CONNECTIVITY_STATE_TO_CHANNEL_CONNECTIVITY = ***REMOVED***
...
CYGRPC_STATUS_CODE_TO_STATUS_CODE = ***REMOVED***
...
***REMOVED***
STATUS_CODE_TO_CYGRPC_STATUS_CODE = ***REMOVED***
...
def fully_qualified_method(group, method):
    return '/***REMOVED******REMOVED***/***REMOVED******REMOVED***'.format(group, method)
