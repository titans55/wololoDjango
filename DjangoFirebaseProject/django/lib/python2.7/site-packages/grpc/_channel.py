...
_USER_AGENT = 'grpc-python/***REMOVED******REMOVED***'.format(_grpcio_metadata.__version__)
...
_NON_OK_RENDEZVOUS_REPR_FORMAT = ('<_Rendezvous of RPC that terminated with:\n'
                                  '\tstatus = ***REMOVED******REMOVED***\n'
                                  '\tdetails = "***REMOVED******REMOVED***"\n'
                                  '\tdebug_error_string = "***REMOVED******REMOVED***"\n'
                                  '>')
...
def _unknown_code_details(unknown_cygrpc_code, details):
    return 'Server sent unknown code ***REMOVED******REMOVED*** and details "***REMOVED******REMOVED***"'.format(
