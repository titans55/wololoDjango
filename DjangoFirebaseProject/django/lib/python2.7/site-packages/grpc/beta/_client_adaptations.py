...
_STATUS_CODE_TO_ABORTION_KIND_AND_ABORTION_ERROR_CLASS = ***REMOVED***
...
class _GenericStub(face.GenericStub):
    ...
    def __init__(self, channel, metadata_transformer, request_serializers,
        ...
        self._channel = channel
        self._metadata_transformer = metadata_transformer
        self._request_serializers = request_serializers or ***REMOVED******REMOVED***
        self._response_deserializers = response_deserializers or ***REMOVED******REMOVED***
