...
class PollRepContent(univ.SequenceOf):
    """
         PollRepContent ::= SEQUENCE OF SEQUENCE ***REMOVED***
         certReqId              INTEGER,
...
class PollReqContent(univ.SequenceOf):
    """
         PollReqContent ::= SEQUENCE OF SEQUENCE ***REMOVED***
         certReqId              INTEGER
     ***REMOVED***
...
class InfoTypeAndValue(univ.Sequence):
    """
    InfoTypeAndValue ::= SEQUENCE ***REMOVED***
...
class CAKeyUpdAnnContent(univ.Sequence):
    """
    CAKeyUpdAnnContent ::= SEQUENCE ***REMOVED***
...
class CertifiedKeyPair(univ.Sequence):
    """
    CertifiedKeyPair ::= SEQUENCE ***REMOVED***
...
class PKIFailureInfo(univ.BitString):
    """
    PKIFailureInfo ::= BIT STRING ***REMOVED***
         badAlg              (0),
         badMessageCheck     (1),
         badRequest          (2),
         badTime             (3),
...
class PKIStatusInfo(univ.Sequence):
    """
    PKIStatusInfo ::= SEQUENCE ***REMOVED***
         status        PKIStatus,
...
class ErrorMsgContent(univ.Sequence):
    """
    ErrorMsgContent ::= SEQUENCE ***REMOVED***
...
class RevAnnContent(univ.Sequence):
    """
    RevAnnContent ::= SEQUENCE ***REMOVED***
         status              PKIStatus,
         certId              CertId,
...
class RevRepContent(univ.Sequence):
    """
    RevRepContent ::= SEQUENCE ***REMOVED***
...
class KeyRecRepContent(univ.Sequence):
    """
    KeyRecRepContent ::= SEQUENCE ***REMOVED***
...
class CertRepMessage(univ.Sequence):
    """
    CertRepMessage ::= SEQUENCE ***REMOVED***
...
class DHBMParameter(univ.Sequence):
    """
    DHBMParameter ::= SEQUENCE ***REMOVED***
         owf                 AlgorithmIdentifier,
         -- AlgId for a One-Way Function (SHA-1 recommended)
         mac                 AlgorithmIdentifier
         -- the MAC AlgId (e.g., DES-MAC, Triple-DES-MAC [PKCS11],
     ***REMOVED***   -- or HMAC [RFC2104, RFC2202])
    """
    componentType = namedtype.NamedTypes(
...
class PKIBody(univ.Choice):
    """
    PKIBody ::= CHOICE ***REMOVED***       -- message-specific body elements
...
class PKIHeader(univ.Sequence):
    """
    PKIHeader ::= SEQUENCE ***REMOVED***
    pvno                INTEGER     ***REMOVED*** cmp1999(1), cmp2000(2) ***REMOVED***,
    sender              GeneralName,
...
class ProtectedPart(univ.Sequence):
    """
     ProtectedPart ::= SEQUENCE ***REMOVED***
         header    PKIHeader,
         body      PKIBody
     ***REMOVED***
    """
