...
class NamedTypes(object):
    ...
    *namedTypes: :class:`~pyasn1.type.namedtype.NamedType`
    ...
    def __init__(self, *namedTypes, **kwargs):
        ...
        self.__ambiguousTypes = 'terminal' not in kwargs and self.__computeAmbiguousTypes() or ***REMOVED******REMOVED***
    ...
    def __computeAmbiguousTypes(self):
        ambiguousTypes = ***REMOVED******REMOVED***
    ...
    def __computeTagMaps(self, unique):
        presentTypes = ***REMOVED******REMOVED***
        skipTypes = ***REMOVED******REMOVED***
        defaultType = None
        for namedType in self.__namedTypes:
            tagMap = namedType.asn1Object.tagMap
            if isinstance(tagMap, NamedTypes.PostponedError):
