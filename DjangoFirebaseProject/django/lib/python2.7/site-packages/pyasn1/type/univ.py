...
class Integer(base.AbstractSimpleAsn1Item):
    ...
    .. code-block:: python
        ...
        class ErrorCode(Integer):
            ...
            ErrorCode ::=
                INTEGER ***REMOVED*** disk-full(1), no-disk(-1),
                          disk-not-formatted(2) ***REMOVED***
...
class BitString(base.AbstractSimpleAsn1Item):
    ...
    .. code-block:: python
        ...
        class Rights(BitString):
            ...
            Rights ::= BIT STRING ***REMOVED*** user-read(0), user-write(1),
                                    group-read(2), group-write(3),
                                    other-read(4), other-write(5) ***REMOVED***

            group1 Rights ::= ***REMOVED*** group-read, group-write ***REMOVED***
...
class ObjectIdentifier(base.AbstractSimpleAsn1Item):
    ...
    .. code-block:: python
        ...
        class ID(ObjectIdentifier):
            ...
            id-edims ID ::= ***REMOVED*** joint-iso-itu-t mhs-motif(6) edims(7) ***REMOVED***
            id-bp ID ::= ***REMOVED*** id-edims 11 ***REMOVED***
            '''
        id_edims = ID('2.6.7')
        id_bp = id_edims + (11,)
    """
...
class Real(base.AbstractSimpleAsn1Item):
    ...
    .. code-block:: python
        ...
        class Pi(Real):
            ...
            pi Pi ::= ***REMOVED*** mantissa 314159, base 10, exponent -5 ***REMOVED***
...
class Enumerated(Integer):
    ...
    .. code-block:: python
        ...
        class RadioButton(Enumerated):
            ...
            RadioButton ::= ENUMERATED ***REMOVED*** button1(0), button2(1),
                                         button3(2) ***REMOVED***
...
class SequenceAndSetBase(base.AbstractConstructedAsn1Item):
    ...
    class DynamicNames(object):
        ...
        def __init__(self):
            self._keyToIdxMap = ***REMOVED******REMOVED***
            self._idxToKeyMap = ***REMOVED******REMOVED***
            ...
            ***REMOVED***
            ...
            componentType=NamedTypes(
                ...
                NamedType('parameter', Any(),
                          openType=OpenType('code', ***REMOVED***1: Integer(),
                                                     2: Real()***REMOVED***))
            )
    ...
    def tagMap(self):
        ...
        try:
            ...
            self._tagMap = tagmap.TagMap(
                ***REMOVED***self.tagSet: self***REMOVED***,
                ***REMOVED***eoo.endOfOctets.tagSet: eoo.endOfOctets***REMOVED***,
                self
            )
