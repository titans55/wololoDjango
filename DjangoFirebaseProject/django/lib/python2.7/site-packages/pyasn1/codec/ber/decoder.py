        ...
        if asn1Spec.typeId in (univ.Sequence.typeId, univ.Set.typeId):
            ...
            if namedTypes:
                ...
                if  namedTypes.hasOpenTypes:
                    ...
                    openTypes = options.get('openTypes', ***REMOVED******REMOVED***)
...
class Decoder(object):
    ...
    def __init__(self, tagMap, typeMap=***REMOVED******REMOVED***):
        self.__tagMap = tagMap
        self.__typeMap = typeMap
        # Tag & TagSet objects caches
        self.__tagCache = ***REMOVED******REMOVED***
        self.__tagSetCache = ***REMOVED******REMOVED***
