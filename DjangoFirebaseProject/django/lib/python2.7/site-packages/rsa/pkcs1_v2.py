...
def mgf1(seed, length, hasher='SHA-1'):
    ...
    try:
        ...
        raise ValueError(
            'Invalid `hasher` specified. Please select one of: ***REMOVED***hash_list***REMOVED***'.format(
    ...
    if length > (2**32 * hash_length):
        raise OverflowError(
            ...
            "length (***REMOVED***hash_length***REMOVED*** for ***REMOVED***hasher***REMOVED*** function)".format(
