...
def generate_requirements(extras_require):
    ...
    extras_require is a dictionary of ***REMOVED***extra: [requirements]***REMOVED*** as passed to setup(),
    using the empty extra ***REMOVED***'': [requirements]***REMOVED*** to hold install_requires.
    """
...
def pkginfo_to_metadata(egg_info_path, pkginfo_path):
    ...
    if os.path.exists(requires_path):
        ...
        for extra, reqs in parsed_requirements:
            for key, value in generate_requirements(***REMOVED***extra: reqs***REMOVED***):
