...
def egg2wheel(egg_path, dest_dir):
    ...
    if not match:
        raise WheelError('Invalid egg file name: ***REMOVED******REMOVED***'.format(filename))
    ...
    dist_info_dir = os.path.join(dir, '***REMOVED***name***REMOVED***-***REMOVED***ver***REMOVED***.dist-info'.format(**egg_info))
    bw.egg2dist(os.path.join(dir, 'EGG-INFO'), dist_info_dir)
    bw.write_wheelfile(dist_info_dir, generator='egg2wheel')
    wheel_name = '***REMOVED***name***REMOVED***-***REMOVED***ver***REMOVED***-***REMOVED***pyver***REMOVED***-***REMOVED******REMOVED***-***REMOVED******REMOVED***.whl'.format(abi, arch, **egg_info)
...
def parse_wininst_info(wininfo_name, egginfo_name):
    ...
    return ***REMOVED***'name': w_name, 'ver': w_ver, 'arch': w_arch, 'pyver': w_pyver***REMOVED***
    ...
    with zipfile.ZipFile(path) as bdw:
        ...
        for zipinfo in bdw.infolist():
            if zipinfo.filename.startswith('PLATLIB'):
                ...
                break
        if root_is_purelib:
            paths = ***REMOVED***'purelib': ''***REMOVED***
        else:
            paths = ***REMOVED***'platlib': ''***REMOVED***
...
def convert(files, dest_dir, verbose):
    ...
    for pat in files:
        for installer in iglob(pat):
            ...
            if verbose:
                print("***REMOVED******REMOVED***... ".format(installer))
                sys.stdout.flush()
