...
class bdist_wheel(Command):
    ...
    def get_tag(self):
        ...
        if self.root_is_pure:
            ...
            assert tag in supported_tags, "would build wheel with unsupported tag ***REMOVED******REMOVED***".format(tag)
        return tag
    ...
    def run(self):
        ...
        archive_basename = "***REMOVED******REMOVED***-***REMOVED******REMOVED***-***REMOVED******REMOVED***-***REMOVED******REMOVED***".format(self.wheel_dist_name, impl_tag, abi_tag, plat_tag)
        ...
        distinfo_dirname = '***REMOVED******REMOVED***-***REMOVED******REMOVED***.dist-info'.format(
    ...
    def egg2dist(self, egginfo_path, distinfo_path):
        ...
        if os.path.isfile(egginfo_path):
            ...
            shutil.copytree(egginfo_path, distinfo_path,
                            ignore=lambda x, y: ***REMOVED***'PKG-INFO', 'requires.txt', 'SOURCES.txt',
                                                 'not-zip-safe'***REMOVED***
                            )
