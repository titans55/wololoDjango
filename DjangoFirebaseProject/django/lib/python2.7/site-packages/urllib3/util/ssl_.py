...
def assert_fingerprint(cert, fingerprint):
    ...
    if not hashfunc:
        raise SSLError(
            'Fingerprint of invalid length: ***REMOVED***0***REMOVED***'.format(fingerprint))
    ...
    if not _const_compare_digest(cert_digest, fingerprint_bytes):
        raise SSLError('Fingerprints did not match. Expected "***REMOVED***0***REMOVED***", got "***REMOVED***1***REMOVED***".'
