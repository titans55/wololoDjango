...
def authenticate_with_limited_privileges():
    ...
    firebase_admin.initialize_app(cred, ***REMOVED***
        'databaseURL': 'https://databaseName.firebaseio.com',
        'databaseAuthVariableOverride': ***REMOVED***
...
def set_value():
    ...
    users_ref.set(***REMOVED***
        'alanisawesome': ***REMOVED***
...
def set_child_value():
    ...
    users_ref.child('alanisawesome').set(***REMOVED***
        'date_of_birth': 'June 23, 1912',
        'full_name': 'Alan Turing'
    ***REMOVED***)
    users_ref.child('gracehop').set(***REMOVED***
        'date_of_birth': 'December 9, 1906',
        'full_name': 'Grace Hopper'
    ***REMOVED***)
    # [END set_child_value]
...
def push_value():
    ...
    new_post_ref.set(***REMOVED***
        'author': 'gracehop',
        'title': 'Announcing COBOL, a New Programming Language'
    ***REMOVED***)

    # We can also chain the two calls together
    posts_ref.push().set(***REMOVED***
...
def order_by_child():
    ...
    for key, val in snapshot.items():
        print('***REMOVED***0***REMOVED*** was ***REMOVED***1***REMOVED*** meters tall'.format(key, val))
    # [END order_by_child]
...
def order_by_value():
    ...
    for key, val in snapshot.items():
        print('The ***REMOVED***0***REMOVED*** dinosaur\'s score is ***REMOVED***1***REMOVED***'.format(key, val))
    # [END order_by_value]
...
def complex_query():
    ...
    if len(snapshot) == 2:
        ...
        for key in snapshot:
            print('The dinosaur just shorter than the stegosaurus is ***REMOVED***0***REMOVED***'.format(key))
            return
    else:
