...
def revoke_refresh_token_uid():
    ...
    print('Tokens revoked at: ***REMOVED***0***REMOVED***'.format(revocation_second))
    # [END revoke_tokens]
    # [START save_revocation_in_db]
    metadata_ref = firebase_admin.db.reference("metadata/" + uid)
    metadata_ref.set(***REMOVED***'revokeTime': revocation_second***REMOVED***)
...
def get_user(uid):
    ...
    user = auth.get_user(uid)
    print('Successfully fetched user data: ***REMOVED***0***REMOVED***'.format(user.uid))
    # [END get_user]
...
def create_user():
    ...
    user = auth.create_user(
        ...
        disabled=False)
    print('Sucessfully created new user: ***REMOVED***0***REMOVED***'.format(user.uid))
    # [END create_user]
    return user.uid
...
def update_user(uid):
    ...
    user = auth.update_user(
        ...
        photo_url='http://www.example.com/12345678/photo.png',
        disabled=True)
    print('Sucessfully updated user: ***REMOVED***0***REMOVED***'.format(user.uid))
    # [END update_user]
...
def set_custom_user_claims(uid):
    ...
    auth.set_custom_user_claims(uid, ***REMOVED***'admin': True***REMOVED***)
...
def set_custom_user_claims_script():
    ...
    if user.email_verified:
        ...
        auth.set_custom_user_claims(user.uid, ***REMOVED***
            'admin': True
        ***REMOVED***)
...
def create_session_cookie(flask, app):
    ...
    def session_login():
        ...
        try:
            ...
            response = flask.jsonify(***REMOVED***'status': 'success'***REMOVED***)
...
def verfy_session_cookie(app, flask):
    def serve_content_for_user(decoded_claims):
        ...
        return flask.jsonify(***REMOVED***'status': 'success'***REMOVED***)
...
def import_users():
    ...
    try:
        ...
        print('Successfully imported ***REMOVED***0***REMOVED*** users. Failed to import ***REMOVED***1***REMOVED*** users.'.format(
            result.success_count, result.failure_count))
        for err in result.errors:
            print('Failed to import ***REMOVED***0***REMOVED*** due to ***REMOVED***1***REMOVED***'.format(users[err.index].uid, err.reason))
    except auth.AuthError:
...
def import_without_password():
    ...
    users = [
        auth.ImportUserRecord(
            ...
            custom_claims=***REMOVED***'admin': True***REMOVED***, # set this user as admin
