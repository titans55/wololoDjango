...
*/
Phaser.TileSprite = function (game, x, y, width, height, key, frame) ***REMOVED***
    ...
    */
    ...
    /**
    * @property ***REMOVED***Phaser.Point***REMOVED*** _scroll - Internal cache var.
    * @private
    */
...
*/
Phaser.TileSprite.prototype.preUpdate = function() ***REMOVED***
...
* @memberof Phaser.TileSprite
* @param ***REMOVED***number***REMOVED*** x - Horizontal scroll speed in pixels per second.
* @param ***REMOVED***number***REMOVED*** y - Vertical scroll speed in pixels per second.
*/
Phaser.TileSprite.prototype.autoScroll = function(x, y) ***REMOVED***
...
* @memberof Phaser.TileSprite
*/
Phaser.TileSprite.prototype.stopScroll = function() ***REMOVED***
...
*/
Phaser.TileSprite.prototype.destroy = function(destroyChildren) ***REMOVED***
...
* @return ***REMOVED***Phaser.TileSprite***REMOVED*** This instance.
*/
Phaser.TileSprite.prototype.reset = function(x, y) ***REMOVED***
