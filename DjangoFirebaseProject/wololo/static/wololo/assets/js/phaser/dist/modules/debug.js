...
*/
Phaser.Utils.Debug = function (game) ***REMOVED***
    ...
    */
    ...
    /**
    * @property ***REMOVED***Phaser.Image***REMOVED*** sprite - If debugging in WebGL mode we need this.
    */
    this.sprite = null;

    /**
    * @property ***REMOVED***Phaser.BitmapData***REMOVED*** bmd - In WebGL mode this BitmapData contains a copy of the debug canvas.
    */
    this.bmd = null;

    /**
    * @property ***REMOVED***HTMLCanvasElement***REMOVED*** canvas - The canvas to which Debug calls draws.
    */
    this.canvas = null;
    ...
    */
    ...
    /**
    * @property ***REMOVED***string***REMOVED*** font - The font that the debug information is rendered in.
    * @default '14px Courier'
    */
    this.font = '14px Courier';

    /**
    * @property ***REMOVED***number***REMOVED*** columnWidth - The spacing between columns.
    */
    this.columnWidth = 100;

    /**
    * @property ***REMOVED***number***REMOVED*** lineHeight - The line height between the debug text.
    */
    this.lineHeight = 16;

    /**
    * @property ***REMOVED***boolean***REMOVED*** renderShadow - Should the text be rendered with a slight shadow? Makes it easier to read on different types of background.
    */
    this.renderShadow = true;

    /**
    * @property ***REMOVED***number***REMOVED*** currentX - The current X position the debug information will be rendered at.
    * @default
    */
    this.currentX = 0;

    /**
    * @property ***REMOVED***number***REMOVED*** currentY - The current Y position the debug information will be rendered at.
    * @default
    */
    this.currentY = 0;

    /**
    * @property ***REMOVED***number***REMOVED*** currentAlpha - The alpha of the Debug context, set before all debug information is rendered to it.
    * @default
    */
    this.currentAlpha = 1;

    /**
    * @property ***REMOVED***boolean***REMOVED*** dirty - Does the canvas need re-rendering?
    */
    this.dirty = false;
...
Phaser.Utils.Debug.prototype = ***REMOVED***
    ...
    * @protected
    * @param ***REMOVED***Phaser.ScaleManager***REMOVED*** scaleManager - The Phaser ScaleManager.
    * @param ***REMOVED***number***REMOVED*** width - The new width of the game.
    * @param ***REMOVED***number***REMOVED*** height - The new height of the game.
    */
    resize: function (scaleManager, width, height) ***REMOVED***
    ...
    * @protected
    * @param ***REMOVED***number***REMOVED*** [x=0] - The X value the debug info will start from.
    * @param ***REMOVED***number***REMOVED*** [y=0] - The Y value the debug info will start from.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - The color the debug text will drawn in.
    * @param ***REMOVED***number***REMOVED*** [columnWidth=0] - The spacing between columns.
    */
    start: function (x, y, color, columnWidth) ***REMOVED***

        if (typeof x !== 'number') ***REMOVED*** x = 0; ***REMOVED***
        if (typeof y !== 'number') ***REMOVED*** y = 0; ***REMOVED***
        color = color || 'rgb(255,255,255)';
        if (columnWidth === undefined) ***REMOVED*** columnWidth = 0; ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sound***REMOVED*** sound - The sound object to debug.
    ...
    */
    soundInfo: function (sound, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Camera***REMOVED*** camera - The Phaser.Camera to show the debug information for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    cameraInfo: function (camera, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Timer***REMOVED*** timer - The Phaser.Timer to show the debug information for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    timer: function (timer, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Pointer***REMOVED*** pointer - The Pointer you wish to display.
    * @param ***REMOVED***boolean***REMOVED*** [hideIfUp=false] - Doesn't render the circle if the pointer is up.
    * @param ***REMOVED***string***REMOVED*** [downColor='rgba(0,255,0,0.5)'] - The color the circle is rendered in if down.
    * @param ***REMOVED***string***REMOVED*** [upColor='rgba(255,0,0,0.5)'] - The color the circle is rendered in if up (and hideIfUp is false).
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    pointer: function (pointer, hideIfUp, downColor, upColor, color) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (hideIfUp === undefined) ***REMOVED*** hideIfUp = false; ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite|Phaser.Image***REMOVED*** sprite - The sprite to display the input data for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    spriteInputInfo: function (sprite, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Key***REMOVED*** key - The Key to render the information for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    key: function (key, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    inputInfo: function (x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite|Phaser.Image***REMOVED*** sprite - The sprite to display the bounds of.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the debug info to be rendered (format is css color string).
    * @param ***REMOVED***boolean***REMOVED*** [filled=true] - Render the rectangle as a fillRect (default, true) or a strokeRect (false)
    */
    spriteBounds: function (sprite, color, filled) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Rope***REMOVED*** rope - The rope to display the segments of.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the debug info to be rendered (format is css color string).
    * @param ***REMOVED***boolean***REMOVED*** [filled=true] - Render the rectangle as a fillRect (default, true) or a strokeRect (false)
    */
    ropeSegments: function (rope, color, filled) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite***REMOVED*** sprite - The Sprite to display the information of.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    spriteInfo: function (sprite, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite|Phaser.Image***REMOVED*** sprite - The sprite to display the coordinates for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    spriteCoords: function (sprite, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Line***REMOVED*** line - The Line to display the data for.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    lineInfo: function (line, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***number***REMOVED*** x - X position of the pixel to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the pixel to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the pixel (format is css color string).
    * @param ***REMOVED***number***REMOVED*** [size=2] - The 'size' to render the pixel at.
    */
    pixel: function (x, y, color, size) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Rectangle|Phaser.Circle|Phaser.Point|Phaser.Line***REMOVED*** object - The geometry object to render.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the debug info to be rendered (format is css color string).
    * @param ***REMOVED***boolean***REMOVED*** [filled=true] - Render the objected as a filled (default, true) or a stroked (false)
    * @param ***REMOVED***number***REMOVED*** [forceType=0] - Force rendering of a specific type. If 0 no type will be forced, otherwise 1 = Rectangle, 2 = Circle, 3 = Point and 4 = Line.
    */
    geom: function (object, color, filled, forceType) ***REMOVED***

        if (filled === undefined) ***REMOVED*** filled = true; ***REMOVED***
        if (forceType === undefined) ***REMOVED*** forceType = 0; ***REMOVED***
    ...
    *
    * @method Phaser.Utils.Debug#geom
    * @param ***REMOVED***Phaser.Rectangle|object***REMOVED*** object - The geometry object to render.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the debug info to be rendered (format is css color string).
    * @param ***REMOVED***boolean***REMOVED*** [filled=true] - Render the objected as a filled (default, true) or a stroked (false)
    */
    rectangle: function (object, color, filled) ***REMOVED***
    ...
    * @param ***REMOVED***string***REMOVED*** text - The line of text to draw.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color] - Color of the debug info to be rendered (format is css color string).
    * @param ***REMOVED***string***REMOVED*** [font] - The font of text to draw.
    */
    text: function (text, x, y, color, font) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.QuadTree***REMOVED*** quadtree - The quadtree to render.
    * @param ***REMOVED***string***REMOVED*** color - The color of the lines in the quadtree.
    */
    quadTree: function (quadtree, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite***REMOVED*** sprite - The Sprite who's body will be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgba(0,255,0,0.4)'] - Color of the debug rectangle to be rendered. The format is a CSS color string such as '#ff0000' or 'rgba(255,0,0,0.5)'.
    * @param ***REMOVED***boolean***REMOVED*** [filled=true] - Render the body as a filled rectangle (true) or a stroked rectangle (false)
    */
    body: function (sprite, color, filled) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite***REMOVED*** sprite - The sprite to be rendered.
    * @param ***REMOVED***number***REMOVED*** x - X position of the debug info to be rendered.
    * @param ***REMOVED***number***REMOVED*** y - Y position of the debug info to be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
    */
    bodyInfo: function (sprite, x, y, color) ***REMOVED***
    ...
    * @param ***REMOVED***Phaser.Sprite***REMOVED*** sprite - The sprite whos body will be rendered.
    * @param ***REMOVED***string***REMOVED*** [color='rgb(0,255,0)'] - color of the debug info to be rendered. (format is css color string).
    */
    box2dBody: function (body, color) ***REMOVED***
    ...
    *
    * @method displayList
    * @param ***REMOVED***Object***REMOVED*** [displayObject] - The displayObject level display object to start from. Defaults to the World.
    */
    displayList: function (displayObject) ***REMOVED***

        if (displayObject === undefined) ***REMOVED*** displayObject = this.game.world; ***REMOVED***
