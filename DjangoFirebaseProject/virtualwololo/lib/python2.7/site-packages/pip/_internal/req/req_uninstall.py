...
def _script_names(dist, script_name, is_gui):
    ...
    ***REMOVED***console,gui***REMOVED***_scripts for the given ``dist``.
...
class UninstallPathSet(object):
    ...
    def from_dist(cls, dist):
        ...
        if dist_path in ***REMOVED***p for p in ***REMOVED***sysconfig.get_path("stdlib"),
        ...
        develop_egg_link_egg_info = '***REMOVED******REMOVED***.egg-info'.format(
        ...
        if (egg_info_exists and dist.egg_info.endswith('.egg-info') and
            ...
            raise UninstallationError(
                "Cannot uninstall ***REMOVED***!r***REMOVED***. It is a distutils installed project "
