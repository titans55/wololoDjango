...
def load_pyproject_toml(use_pep517, pyproject_toml, setup_py, req_name):
    ...
    if has_pyproject and not has_setup:
        ...
        if use_pep517 is False:
            raise InstallationError(
                "Disabling PEP 517 processing is invalid: "
                "project specifies a build backend of ***REMOVED******REMOVED*** "
    ...
    # to PEP 518.
    error_template = (
        "***REMOVED***package***REMOVED*** has a pyproject.toml file that does not comply "
        "with PEP 518: ***REMOVED***reason***REMOVED***"
    )
