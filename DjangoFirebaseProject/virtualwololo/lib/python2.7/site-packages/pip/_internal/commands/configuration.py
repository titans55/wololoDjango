...
class ConfigurationCommand(Command):
    ...
    def run(self, options, args):
        ...
        ***REMOVED***
        ...
        if not args or args[0] not in handlers:
            logger.error("Need an action (***REMOVED******REMOVED***) to perform.".format(
    ...
    def open_in_editor(self, options, args):
        ...
        try:
            ...
            raise PipError(
                "Editor Subprocess exited with exit code ***REMOVED******REMOVED***"
                .format(e.returncode)
            )
    ...
    def _get_n_args(self, args, example, n):
        ...
        if len(args) != n:
            msg = (
                'Got unexpected number of arguments, expected ***REMOVED******REMOVED***. '
                '(example: "***REMOVED******REMOVED*** config ***REMOVED******REMOVED***")'
