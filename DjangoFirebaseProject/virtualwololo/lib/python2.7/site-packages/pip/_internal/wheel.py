...
def get_entrypoints(filename):
    ...
    console = entry_points.get('console_scripts', ***REMOVED******REMOVED***)
    gui = entry_points.get('gui_scripts', ***REMOVED******REMOVED***)
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    ***REMOVED***
    ...
    for parent_dir, scripts in warn_for.items():
        ...
        if len(scripts) == 1:
            start_text = "script ***REMOVED******REMOVED*** is".format(scripts[0])
        else:
            start_text = "scripts ***REMOVED******REMOVED*** are".format(
                ", ".join(scripts[:-1]) + " and " + scripts[-1]
            )

        msg_lines.append(
            "The ***REMOVED******REMOVED*** installed in '***REMOVED******REMOVED***' which is not on PATH."
            .format(start_text, parent_dir)
        )

    last_line_fmt = (
        "Consider adding ***REMOVED******REMOVED*** to PATH or, if you prefer "
...
def move_wheel_files(name, req, wheeldir, user=False, home=None, root=None,
    ...
    maker.variants = ***REMOVED***''***REMOVED***
    ...
    def _get_script_text(entry):
        ...
        return maker.script_template % ***REMOVED***
            "module": entry.prefix,
