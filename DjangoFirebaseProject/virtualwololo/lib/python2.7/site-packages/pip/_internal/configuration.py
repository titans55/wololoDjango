...
class Configuration(object):
    ...
    def __init__(self, isolated, load_only=None):
        ...
        if load_only not in _valid_load_only:
            raise ConfigurationError(
                "Got invalid value for load_only - should be one of ***REMOVED******REMOVED***".format(
        ...
        self._parsers = ***REMOVED***
            variant: [] for variant in self._override_order
        ***REMOVED***  # type: Dict[Kind, List[Tuple[str, RawConfigParser]]]
        self._config = ***REMOVED***
            variant: ***REMOVED******REMOVED*** for variant in self._override_order
        ***REMOVED***  # type: Dict[Kind, Dict[str, Any]]
    ...
    def get_value(self, key):
        ...
        try:
            ...
            raise ConfigurationError("No such key - ***REMOVED******REMOVED***".format(key))
        ...
        if os.path.exists(fname):
            try:
                ...
                raise ConfigurationFileCouldNotBeLoaded(
                    reason="contains invalid ***REMOVED******REMOVED*** characters".format(
