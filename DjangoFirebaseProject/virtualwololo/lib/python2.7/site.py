...
/usr/***REMOVED***lib,share***REMOVED***/python<version>/dist-packages.
...
def addbuilddir():
    ...
    s = "build/lib.***REMOVED******REMOVED***-***REMOVED***:.3***REMOVED***".format(get_platform(), sys.version)
...
def setquit():
    ...
    class Quitter(object):
        ...
        def __repr__(self):
            return "Use ***REMOVED******REMOVED***() or ***REMOVED******REMOVED*** to exit".format(self.name, eof)
...
def _script():
    ...
    if not args:
        print("sys.path = [")
        for dir in sys.path:
            print("    ***REMOVED***!r***REMOVED***,".format(dir))
        print("]")
        ...
        print("USER_BASE: ***REMOVED***!r***REMOVED*** (***REMOVED******REMOVED***)".format(USER_BASE, exists(USER_BASE)))
        print("USER_SITE: ***REMOVED***!r***REMOVED*** (***REMOVED******REMOVED***)".format(USER_SITE, exists(USER_SITE)))
